...
class PlayingCardView: UIView {
    ...
    @objc func adjustFaceCardScale(byHandlineGestureRecognisedBy recogniser: UIPinchGestureRecognizer) {
    ...
    // To support accecebility when changing slider for text font
